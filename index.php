          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                ...
                <h5 align="center">IMPS STUDENT MANAGEMENT SYSTEM</h5>
                  ...
                  <select required name="userType" class="form-control mb-3">
                          ...
                          <option value="Administrator">Admin Section</option>
                          <option value="ClassTeacher">Teacher Section</option>
                        </select>
                    </div>
                    <div class="form-group">
